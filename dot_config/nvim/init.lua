...
require("lazy").setup({
  spec = {
    ...
    -- fzf ファイル・コマンド検索
    {
      ...
      event = 'VeryLazy',
      config = function()
        vim.api.nvim_set_keymap('n', '<C-o>', "<cmd>lua require('telescope.builtin').find_files({hidden = true})<CR>", { noremap = true, silent = true })
        ...
        vim.api.nvim_set_keymap('n', '<C-x>', "<cmd>lua require('telescope.builtin').commands()<CR>", { noremap = true, silent = true })
        vim.api.nvim_set_keymap('n', '<C-z>', "<cmd>lua require('telescope.builtin').keymaps()<CR>", { noremap = true, silent = true })
        vim.api.nvim_set_keymap('n', '<Leader>h', "<cmd>Telescope notify<CR>", { noremap = true, silent = true })
        vim.api.nvim_set_keymap('n', '<Leader>s', "<cmd>Telescope simulators run<CR>", { noremap = true, silent = true })

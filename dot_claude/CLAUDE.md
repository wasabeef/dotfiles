...
作業が完全に完了し、これ以上継続するタスクがない場合、または確認必須項目でユーザー確認が必要な場合は一語一句違えずに以下を報告する：
...
- ✅ 確認必須項目（新規ファイル作成、ファイル削除、構造変更等）に該当
- ✅ ユーザーへの確認が必要な状況
...
- ⚠️ **毎回確認必須**：コミット前には必ずユーザーに確認を求める
- ⚠️ **自動継続禁止**：一度コミットを許可されても、次のコミット時には改めて確認する
- ⚠️ **明示的許可**：ユーザーの明示的な許可なしにコミットを実行しない
